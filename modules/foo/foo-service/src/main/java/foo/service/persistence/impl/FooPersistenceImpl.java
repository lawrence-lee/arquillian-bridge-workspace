...
package foo.service.persistence.impl;
...
import foo.model.impl.FooImpl;
import foo.model.impl.FooModelImpl;

import foo.service.persistence.FooPersistence;
import foo.service.persistence.impl.constants.FOOPersistenceConstants;
...
public class FooPersistenceImpl
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.foo.model.Foo"),
			true);
	}
