...
public class FooLocalServiceWrapper
	 ...
	 */
	@Override
	public foo.model.Foo addFoo(foo.model.Foo foo) {
	 ...
	 */
	@Override
	public foo.model.Foo createFoo(long fooId) {
	 ...
	 */
	@Override
	public foo.model.Foo deleteFoo(foo.model.Foo foo) {
	 ...
	 */
	@Override
	public foo.model.Foo deleteFoo(long fooId)
	...
	@Override
	public foo.model.Foo fetchFoo(long fooId) {
	 ...
	 */
	@Override
	public foo.model.Foo fetchFooByUuidAndGroupId(String uuid, long groupId) {
	 ...
	 */
	@Override
	public foo.model.Foo getFoo(long fooId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public foo.model.Foo getFooByUuidAndGroupId(String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<foo.model.Foo> getFoos(int start, int end) {
	 ...
	 */
	@Override
	public java.util.List<foo.model.Foo> getFoosByUuidAndCompanyId(
	 ...
	 */
	@Override
	public foo.model.Foo updateFoo(foo.model.Foo foo) {
